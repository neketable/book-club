...
moduleForAcceptance('[AGAT] Acceptance | i i s book club встреча клуба l');

test('testing i-i-s-book-club-встреча-клуба-l', function(assert) {
  visit('/i-i-s-book-club-встреча-клуба-l');
