...
moduleForAcceptance('[AGAT] Acceptance | i i s book club план встречи l');

test('testing i-i-s-book-club-план-встречи-l', function(assert) {
  visit('/i-i-s-book-club-план-встречи-l');
